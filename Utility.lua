...
function WebDKP_SelectPlayerOnly(toHighlight)
    ...
    if WebDKP_PlayerIsShown(toHighlight) then
...
function WebDKP_GetDKP(playerName, tableid, addToTable, class)
    ...
    elseif (WebDKP_DkpTable[main]["dkp_" .. tableid] == nil) then
        ...
        retDkp = WebDKP_DkpTable[main]["dkp_" .. tableid];
        retLifeTime = WebDKP_DkpTable[main]["dkp_lifetime_" .. tableid];
    end
    return retDkp,retLifeTime;
end
